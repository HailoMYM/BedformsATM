...
handles.ProjectFolder = [handles.DocumentsPath '\Projects\' handles.NameProject];
...
while ( exist(handles.ProjectFolder,'dir') )
    ...
    switch choice
        ...
        case 'Enter other name'
            ...
            handles.ProjectFolder = [handles.DocumentsPath '\Projects\'...
                                     handles.NameProject];
...
load( [handles.ProjectFolder '\input\inputfile.mat'], 'outFile','Dformat' );
load( [handles.ProjectFolder '\input\XYZdata.mat'], 'XYZ' )
...
function timetest_Callback(hObject, eventdata, handles)
    ...
    rmdir([handles.ProjectFolder '\Wavelet_Output'], 's');
    delete(wb);
